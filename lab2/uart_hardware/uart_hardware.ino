 ...
 */
 ...
 #define FOSC 1843200 //provides 0 error with 9600 baud
...
void uart_hardware_init() {
    UBRR0H = (uint8_t) (BAUD_RATE>>8); //write the 4 most significant bits of the baud rate to the high bit register
    UBRR0L = (uint8_t) BAUD_RATE;      //write the 8 least significant bits of the baud rate to the low bit register
